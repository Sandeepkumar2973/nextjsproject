...
const FeaturesTab = () => {
  ...
  return (
    <>
      {/* <!-- ===== Features Tab Start ===== --> */}
      <section className="relative  pt-8.5 lg:pb-1.5">
        <h3 className='mb-2 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle2 text-center'>Why Students Choose ASPIRATIONS INC.</h3>
        <br />
        <div className="relative mx-auto max-w-c-1300 px-4 md:px-8 2xl:px-0">
          <div className="absolute -top-10 -z-1 mx-auto h-[350px] w-[90%]">
            <Image
              fill
